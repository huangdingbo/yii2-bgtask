            ...
            [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model, $key) {
                            return \common\helpers\Html::a('查看', ['view','id' => $model->id], [
                                'data-toggle' => 'modal',
                        ...
                        'update' => function ($url, $model, $key) {
                            return \common\helpers\Html::a('修改', ['update','id' => $model->id], [
                                'data-toggle' => 'modal',
                                'data-target' => '#view-modal',
                        ...
                        'log' => function ($url, $model, $key) {
                            return \common\helpers\Html::a('日志', ['log','id' => $model->id], [
                                'data-toggle' => 'modal',
                        ...
                        'switch' => function ($url, $model, $key) {
                            ...
                            return \common\helpers\Html::a("{$showName}",['switch','id' => $model->id,'is_open' => $model->is_open],[
                                'data-method' => 'post',
                        ...
                        'replace' => function ($url, $model, $key) {
                            return \common\helpers\Html::a('重置',['replace', 'id' => $model->id],[
                                'data-method' => 'post',
                        ...
                        'delete' => function ($url, $model, $key) {
                            return \common\helpers\Html::a('删除',['delete', 'id' => $model->id],[
                                'data-method' => 'post',
